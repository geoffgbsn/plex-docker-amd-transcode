ARG PLEX_VER=1.27.1.5916-6b0e31a64
...
FROM geoffgbsn/alpine:3.16 AS builder
...
LABEL maintainer="Gibbysoft <admin@gibbyserv.com>" \
      org.label-schema.vendor="Gibbysoft" \
